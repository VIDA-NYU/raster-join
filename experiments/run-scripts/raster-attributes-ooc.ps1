...
ForEach($nAttrib in $attribs) {
	...
	$arguments = "--nIter", 6, "--joinType", "raster", "--accuracy", 10, "--backendIndexName", "$index", "--locAttrib", 1, "--polygonList", "$polyList", "--polygonDataset", "neigh", "--startTime", 1230768000, "--endTime", 1272808000, "--nAttrib", $nAttrib, "--outputTime", "$opFile", "--gpuMem", $GpuMem
