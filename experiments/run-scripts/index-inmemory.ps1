...
ForEach($endTime in $inMemTimes) {
	...
	$arguments = "--nIter", 6, "--joinType", "index", "--indexRes", 1024, "--backendIndexName", "$index", "--locAttrib", 1, "--polygonList", "$polyList", "--polygonDataset", "neigh", "--startTime", 1230768000, "--endTime", $endTime, "--inmem", "--outputTime", "$opFile"
