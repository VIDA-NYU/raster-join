...
{
public:
    //PartitioningManager(Dataset* ds, QString indexFileStem); //constructor for building the index
    //PartitioningManager (QString indexFileStem); //constructor for querying the index
    //~PartitioningManager();
